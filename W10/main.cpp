...
// The main function has been modified to call the search and listArrayElements
// functions as per the workshop description and comments.
//
// Revision History
// -----------------------------------------------------------
// Name            Date            Reason
// Chaerin Yoo     2024-07-32      Modified main function to include calls to search
//                                 and listArrayElements functions, as required by the
...
int main() {
    ...
    // Search for students with 4.0 GPA
    ...
    // Call the search function to search the array E 
    // and store the matches in Eres passing 111 as the key argument
    // Search for employees with office number 111
    ...
    // Search for employees with office number 555
    ...
    // Title: "INTEGERS"
    // List all integers in the array
